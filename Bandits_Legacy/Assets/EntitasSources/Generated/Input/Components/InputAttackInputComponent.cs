...
public partial class InputContext {
    ...
    public InputEntity SetAttackInput(bool newIsPressed) {
        if (hasAttackInput) {
        ...
        entity.AddAttackInput(newIsPressed);
        return entity;
    }

    public void ReplaceAttackInput(bool newIsPressed) {
        var entity = attackInputEntity;
        if (entity == null) {
            entity = SetAttackInput(newIsPressed);
        } else {
            entity.ReplaceAttackInput(newIsPressed);
        }
    }
...
public partial class InputEntity {
    ...
    public void AddAttackInput(bool newIsPressed) {
